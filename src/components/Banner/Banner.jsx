          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                <h1 className="text-3xl text-primary sm:text-4xl font-bold">
                  Briyani Lovers 
                </h1>
                <p className="text-sm text-gray-500 capitalize tracking-wide leading-5">
                  If Someone Say True True Love Never Exit make them taste Briyani
                  <br />
                  <br />
                  the only thing better than being in love eating briyani
                </p>
