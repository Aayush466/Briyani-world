      ...
      <div className="bg-gray-100 dark:bg-gray-800 py-14">
        <div className="container">
          <div className="grid sm:grid-cols-2 grid-cols-1 items-center gap-4">
            <div>
              <h1 className="text-2xl text-center capitalize sm:text-left sm:text-4xl font-semibold text-gray-700 dark:text-gray-400">
              Briyani is available for Android and IOS
              </h1>
